...
import logo from '../../assets/Hand shake wing logo (100 × 100 px) (100 × 80 px).png'
    ...
    return (
        <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
            <div className="relative flex items-center justify-between">
                <Link
                    to="/"
                    aria-label="Najmul Sakib"
                    title="Najmul Sakib"
                    className="inline-flex items-center"
                >
                    <img src={logo} alt="" className="rounded-full h-16 w-16" />
                    <span className="ml-2 text-xl font-bold tracking-wide uppercase">
                        <span className="text-cyan-400 text-center"> Najmul Sakib</span>
                    </span>
                </Link>
                <ul className="flex items-center hidden ml-56 space-x-8 lg:flex">
                    <li>
                        <Link
                            to="/"
                            aria-label="Home"
